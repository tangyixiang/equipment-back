...
values ('11', '数据分析', 5, 0, 'analysis', NULL, NULL, 1, 0, 'C', '1', '0', NULL, '#', 'admin', sysdate(), '', NULL,
        '数据分析');
insert into sys_menu
values ('12', '个人中心', 6, 0, 'center', NULL, NULL, 1, 0, 'C', '1', '0', NULL, '#', 'admin', sysdate(), '', NULL,
        '个人中心');
insert into sys_menu
values ('13', '设置', 6, 0, 'settings', NULL, NULL, 1, 0, 'C', '1', '0', NULL, '#', 'admin', sysdate(), '', NULL,
        '设置');
...
insert into sys_menu
values ('109', '日志管理', '1', '10', 'log', '', '', 1, 0, 'M', '0', '0', '', 'BlockOutlined', 'admin', sysdate(), '',
        null,
        '日志管理菜单');
insert into sys_menu
...
insert into sys_menu
values ('117', '代码生成', '3', '2', 'gen', 'tool/gen/index', '', 1, 0, 'C', '0', '0', 'tool:gen:list',
        'PrinterOutlined',
