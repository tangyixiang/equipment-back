...
public class MockApiContoller {
    ...
    public Result getFakeListDetail() {
    ...
    public Result getProjectNotice() {
        JSONArray info = new JSONArray();
        JSONObject item = new JSONObject();
        item.put("id", "xxx1");
    ...
    public Result getWorkplaceChartData() {
        return getChartData("work");
    }

    @GetMapping("/fake_analysis_chart_data")
    public Result getAnalysisChartData() {
        return getChartData("analysis");
    }

    public Result getChartData(String type) {
